...
async def get_summary(symbol: str, db: AsyncSession = Depends(get_db)):
    ...
    data = {
        ...
        "latest_open": latest_price.open if latest_price else None,
        "latest_high": latest_price.high if latest_price else None,
        "latest_low": latest_price.low if latest_price else None,
